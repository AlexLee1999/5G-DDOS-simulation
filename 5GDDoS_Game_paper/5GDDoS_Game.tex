...
\begin{figure}[!]
    ...
    \subfloat[Different Malicious and Normal Ratio\label{subfig-1:ratio}]{%
      \includegraphics[width=0.24\textwidth]{5GDDoS_Game_utility_ratio.pdf}
    }
    \subfloat[Different IPS VM Ratio\label{subfig-2:cmp}]{%
      \includegraphics[width=0.24\textwidth]{5GDDoS_Game_utility_cmp.pdf}
    }
...
\label{MPO_cmp}
We compare different scheme of IPS VM allocation. These schemes include $0\%$, $30\%$, $90\%$ IPS VM, and random percent of IPS VM choosen from $0\% $ to $99.9\%$. As seen in (\ref{subfig-2:cmp}), our proposed scheme has largest social welfare compare with other allocation schemes.
