...
\begin{figure}[H]
    \subfloat[Case 1\label{subfig-1:aspzh1}]{%
      \includegraphics[width=0.23\textwidth]{5GDDoS_Game_asp_utility_z_h_case1.pdf}
    }
    \subfloat[Case 2\label{subfig-2:aspzh2}]{%
      \includegraphics[width=0.23\textwidth]{5GDDoS_Game_asp_utility_z_h_case2.pdf}
    }
    \hfill
    \subfloat[Case 1\label{subfig-1:aspzv1}]{%
      \includegraphics[width=0.23\textwidth]{5GDDoS_Game_asp_utility_case1.pdf}
    }
    \subfloat[Case 2\label{subfig-2:aspzv2}]{%
      \includegraphics[width=0.23\textwidth]{5GDDoS_Game_asp_utility_case2.pdf}
    }
    \hfill
    \subfloat[Purchased VM\label{subfig-1:VMnum}]{%
      \includegraphics[width=0.23\textwidth]{5GDDoS_Game_vm_number.pdf}
    }
    \subfloat[MPO Utility\label{subfig-2:MPOutil}]{%
      \includegraphics[width=0.23\textwidth]{5GDDoS_Game_utility.pdf}
    }
    \hfill
    \subfloat[Malicious Users Ratio\label{subfig-1:ratio}]{%
      \includegraphics[width=0.23\textwidth]{5GDDoS_Game_utility_ratio.pdf}
    }
    \subfloat[\label{subfig-2:cmp}]{%
      \includegraphics[width=0.23\textwidth]{5GDDoS_Game_utility_cmp.pdf}
    }
