...
The optimal point of $Y_i^3(z_i^v|\Psi_m^v)$ never happens at the boundary of (\ref{eqn:asp_utility_def_opti_const2}).
\end{lemma}
\begin{proof}
...
\label{MPO_cmp}
We proposed the allocation scheme mentioned above.
