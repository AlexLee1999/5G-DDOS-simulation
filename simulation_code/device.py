...
class Device():
    def __init__(self, bandwidth):
        ...
        self.log_snr = math.log2(1 + self.tx_power * 10E10 * 10**(-(22*math.log10(self.distance)+28+20*math.log10(self.frequency))/10))
    ...
    def __str__(self):
        return f"latency_requirement : {self.latency_requirement}\n" \
