...
class MPO():
    ...
    def plot_MPO_utility(self):
        ...
        plt.vlines(self.bd + self.qbd, ymin=min(ut), ymax=max(ut), linestyle='dashed', color='black', label='Boundary', linewidth=LINE_WIDTH)
        ...
        plt.vlines(self.cp, ymin=min(ut), ymax=max(ut), linestyle=(0, (3, 5, 1, 5)), color='green', label='Switch', linewidth=LINE_WIDTH)
        ...
        plt.vlines(self.bd + self.qbd, ymin=min(num), ymax=max(num), linestyle='dashed', color='black', label='Boundary', linewidth=LINE_WIDTH)
        ...
        plt.vlines(self.cp, ymin=min(num), ymax=max(num), linestyle=(0, (3, 5, 1, 5)), color='green', label='Switch', linewidth=LINE_WIDTH)
        plt.legend(loc="best", fontsize=LEGEND_FONT_SIZE)
        plt.xlabel(r'$\bf{MPO\ Price}$', fontsize=LABEL_FONT_SIZE)
        ...
        plt.vlines(self.bd + self.qbd, ymin=min(asp_ut), ymax=max(asp_ut), linestyle='dashed', color='black', label='Boundary', linewidth=LINE_WIDTH)
        ...
        plt.vlines(self.cp, ymin=min(asp_ut), ymax=max(asp_ut), linestyle=(0, (3, 5, 1, 5)), color='green', label='Switch', linewidth=LINE_WIDTH)
        plt.legend(loc="best", fontsize=LEGEND_FONT_SIZE)
        plt.xlabel(r'$\bf{MPO\ Price}$', fontsize=LABEL_FONT_SIZE)
    ...
    def plot_social_welfare(self):
        ...
        for _ in range(20):
            ...
            vm_prior = vm_after
        plt.figure(figsize=FIG_SIZE, dpi=DPI)
        plt.plot(pr, ut, marker='o', linestyle='-.', label='Proposed', linewidth=LINE_WIDTH, markersize=MARKER_SIZE)
        plt.plot(pr_zh1, ut_zh1, marker='s', linestyle='-.', label='No IPS VM', linewidth=LINE_WIDTH, markersize=MARKER_SIZE)
        plt.plot(pr_zh2, ut_zh2, marker='p', linestyle='-.', label='5% IPS VM', linewidth=LINE_WIDTH, markersize=MARKER_SIZE)
        plt.plot(pr_zh4, ut_zh4, marker='^', linestyle='-.', label='9% IPS VM', linewidth=LINE_WIDTH, markersize=MARKER_SIZE)
        plt.xlabel(r'$\bf{MPO\ Price}$', fontsize=LABEL_FONT_SIZE)
