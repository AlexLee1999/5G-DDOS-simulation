...
def plot_utility_device_num_low_cvx():
        ...
        while i < ITER:
            try:
                mpo = MPO(DEFAULT_DEVICE_RATIO, n,
                          load_type.LOW, MPO_NUM_OF_ASP, DEFAULT_ETA)
    ...
    fig_name = "device_number_low/5GDDoS_Game_MPO_device_low_cvx"
    ...
    if JPG_ENABLE:
        plt.savefig(
            './image/device_number_low/5GDDoS_Game_social_device_low_cvx.jpg')
    plt.savefig(
        './image/device_number_low/5GDDoS_Game_social_device_low_cvx.pdf')
    plt.savefig(
        './image/device_number_low/5GDDoS_Game_social_device_low_cvx.eps')
    data_dic = dict()
    ...
    fig_name = "device_number_low/5GDDoS_Game_social_device_low_cvx"
    fig = Fig(num, data_dic, x_title, y_title, fig_name, marker_dic)
    write_fig(fig, fig_name)
    plt.close()
    ...
    fig_name = "device_number_low/5GDDoS_Game_asp_device_low_cvx"
    fig = Fig(num, data_dic, x_title, y_title, fig_name, marker_dic)
    write_fig(fig, fig_name)
    plt.close()
    ...
    if JPG_ENABLE:
        plt.savefig(
            './image/device_number_low/5GDDoS_Game_total_vm_device_low_cvx.jpg')
    plt.savefig(
        './image/device_number_low/5GDDoS_Game_total_vm_device_low_cvx.pdf')
    plt.savefig(
        './image/device_number_low/5GDDoS_Game_total_vm_device_low_cvx.eps')
    data_dic = dict()
    ...
    fig_name = "device_number_low/5GDDoS_Game_total_vm_device_low_cvx"
    fig = Fig(num, data_dic, x_title, y_title, fig_name, marker_dic)
    write_fig(fig, fig_name)
    plt.close()
...
def plot_utility_device_num_low_step():
    ...
    data_dic["5% IPS VM"] = utility_five_lst
    data_dic["7% IPS VM"] = utility_seven_lst
    fig_name = "device_number_low/5GDDoS_Game_MPO_device_low_step"
    fig = Fig(num, data_dic, x_title, y_title, fig_name, marker_dic)
    write_fig(fig, fig_name)
    plt.close()
    ...
    if JPG_ENABLE:
        plt.savefig(
            './image/device_number_low/5GDDoS_Game_social_device_low_step.jpg')
    plt.savefig(
        './image/device_number_low/5GDDoS_Game_social_device_low_step.pdf')
    plt.savefig(
        './image/device_number_low/5GDDoS_Game_social_device_low_step.eps')
    data_dic = dict()
    data_dic["Proposed Scheme"] = social_proposed_lst
    data_dic["No IPS"] = social_zero_lst
    data_dic["5% IPS VM"] = social_five_lst
    data_dic["7% IPS VM"] = social_seven_lst
    fig_name = "device_number_low/5GDDoS_Game_social_device_low_step"
    fig = Fig(num, data_dic, x_title, y_title, fig_name, marker_dic)
    write_fig(fig, fig_name)
    plt.close()
    ...
    data_dic["5% IPS VM"] = asp_utility_five_lst
    data_dic["7% IPS VM"] = asp_utility_seven_lst
    fig_name = "device_number_low/5GDDoS_Game_asp_device_low_step"
    fig = Fig(num, data_dic, x_title, y_title, fig_name, marker_dic)
    write_fig(fig, fig_name)
    plt.close()
    ...
    if JPG_ENABLE:
        plt.savefig(
            './image/device_number_low/5GDDoS_Game_total_vm_device_low_step.jpg')
    plt.savefig(
        './image/device_number_low/5GDDoS_Game_total_vm_device_low_step.pdf')
    plt.savefig(
        './image/device_number_low/5GDDoS_Game_total_vm_device_low_step.eps')
    data_dic = dict()
    data_dic["Proposed Scheme"] = vm_proposed_lst
    data_dic["No IPS"] = vm_zero_lst
    data_dic["5% IPS VM"] = vm_five_lst
    data_dic["7% IPS VM"] = vm_seven_lst
    fig_name = "device_number_low/5GDDoS_Game_total_vm_device_low_step"
    fig = Fig(num, data_dic, x_title, y_title, fig_name, marker_dic)
    write_fig(fig, fig_name)
    plt.close()
