...
def plot_utility_device_num_high_step():
    ...
    fig_name = "device_number_high/5GDDoS_Game_MPO_device_high_step"
    ...
    fig_name = "device_number_high/5GDDoS_Game_social_device_high_step"
    fig = Fig(num, data_dic, x_title, y_title, fig_name, marker_dic)
    write_fig(fig, fig_name)
    plt.close()
    ...
    fig_name = "device_number_high/5GDDoS_Game_asp_device_high_step"
    fig = Fig(num, data_dic, x_title, y_title, fig_name, marker_dic)
    write_fig(fig, fig_name)
    plt.close()
    ...
    fig_name = "device_number_high/5GDDoS_Game_total_vm_device_high_step"
    fig = Fig(num, data_dic, x_title, y_title, fig_name, marker_dic)
    write_fig(fig, fig_name)
    plt.close()