...
def plot_utility_device_num_high_step():
    ...
    if JPG_ENABLE:
        plt.savefig(
            './image/device_number_high/5GDDoS_Game_MPO_device_high_step.jpg')
    plt.savefig(
        './image/device_number_high/5GDDoS_Game_MPO_device_high_step.pdf')
    plt.savefig(
        './image/device_number_high/5GDDoS_Game_MPO_device_high_step.eps')
    data_dic = dict()
    data_dic["Proposed Scheme"] = utility_proposed_lst
    data_dic["No IPS"] = utility_zero_lst
    data_dic["5% IPS VM"] = utility_five_lst
    ...
    if JPG_ENABLE:
        plt.savefig(
            './image/device_number_high/5GDDoS_Game_social_device_high_step.jpg')
    plt.savefig(
        './image/device_number_high/5GDDoS_Game_social_device_high_step.pdf')
    plt.savefig(
        './image/device_number_high/5GDDoS_Game_social_device_high_step.eps')
    data_dic = dict()
    data_dic["Proposed Scheme"] = social_proposed_lst
    data_dic["No IPS"] = social_zero_lst
    data_dic["5% IPS VM"] = social_five_lst
    ...
    if JPG_ENABLE:
        plt.savefig(
            './image/device_number_high/5GDDoS_Game_asp_device_high_step.jpg')
    plt.savefig(
        './image/device_number_high/5GDDoS_Game_asp_device_high_step.pdf')
    plt.savefig(
        './image/device_number_high/5GDDoS_Game_asp_device_high_step.eps')
    data_dic = dict()
    data_dic["Proposed Scheme"] = asp_utility_proposed_lst
    data_dic["No IPS"] = asp_utility_zero_lst
    data_dic["5% IPS VM"] = asp_utility_five_lst
    ...
    if JPG_ENABLE:
        plt.savefig(
            './image/device_number_high/5GDDoS_Game_total_vm_device_high_step.jpg')
    plt.savefig(
        './image/device_number_high/5GDDoS_Game_total_vm_device_high_step.pdf')
    plt.savefig(
        './image/device_number_high/5GDDoS_Game_total_vm_device_high_step.eps')
    data_dic = dict()
    data_dic["Proposed Scheme"] = vm_proposed_lst
    data_dic["No IPS"] = vm_zero_lst
    data_dic["5% IPS VM"] = vm_five_lst
