...
def plot_ratio_with_same_IPS_ratio_cvx():
    ...
    plt.plot(ratio, util_fix, marker='^', markerfacecolor='none', label='Propotional IPS ratio', linewidth=LINE_WIDTH, markersize=MARKER_SIZE)
    ...
    plt.savefig('./image/same_ips/5GDDoS_Game_MPO_ratio_with_same_IPS_ratio_cvx.jpg')
    plt.savefig('./image/same_ips/5GDDoS_Game_MPO_ratio_with_same_IPS_ratio_cvx.pdf')
    plt.savefig('./image/same_ips/5GDDoS_Game_MPO_ratio_with_same_IPS_ratio_cvx.eps')
    plt.close()
    ...
    plt.plot(ratio, social_fix, marker='^', markerfacecolor='none', label='Propotional IPS ratio', linewidth=LINE_WIDTH, markersize=MARKER_SIZE)
    plt.legend(loc="best", fontsize=LEGEND_FONT_SIZE)
    plt.xlabel(r'$\bf{Malicious\ Users\ to\ Normal\ Users\ Ratio}$', fontsize=LABEL_FONT_SIZE)
    ...
    plt.xticks(fontsize=TICKS_FONT_SIZE)
    plt.yticks(fontsize=TICKS_FONT_SIZE)
    plt.savefig('./image/same_ips/5GDDoS_Game_social_ratio_with_same_IPS_ratio_cvx.jpg')
    plt.savefig('./image/same_ips/5GDDoS_Game_social_ratio_with_same_IPS_ratio_cvx.pdf')
    plt.savefig('./image/same_ips/5GDDoS_Game_social_ratio_with_same_IPS_ratio_cvx.eps')
    plt.close()
    ...
    plt.plot(ratio, asp_util_fix, marker='^', markerfacecolor='none', label='Propotional IPS ratio', linewidth=LINE_WIDTH, markersize=MARKER_SIZE)
    plt.xlabel(r'$\bf{Malicious\ Users\ to\ Normal\ Users\ Ratio}$', fontsize=LABEL_FONT_SIZE)
    plt.ylabel(r'$\bf{ASP\ Utility}$', fontsize=LABEL_FONT_SIZE)
    plt.legend(loc="best", fontsize=LEGEND_FONT_SIZE)
    plt.xticks(fontsize=TICKS_FONT_SIZE)
    plt.yticks(fontsize=TICKS_FONT_SIZE)
    plt.savefig('./image/same_ips/5GDDoS_Game_asp_ratio_with_same_IPS_ratio_cvx.jpg')
    plt.savefig('./image/same_ips/5GDDoS_Game_asp_ratio_with_same_IPS_ratio_cvx.pdf')
    plt.savefig('./image/same_ips/5GDDoS_Game_asp_ratio_with_same_IPS_ratio_cvx.eps')
    plt.close()
