...
def plot_utility_ratio_low_new_step():
    ...
    fig_name = "ratio_low_new/5GDDoS_Game_MPO_ratio_low_new_step"
    ...
    plt.xticks(fontsize=TICKS_FONT_SIZE)
    plt.yticks(fontsize=TICKS_FONT_SIZE)
    plt.savefig('./image/ratio_low_new/5GDDoS_Game_social_ratio_low_new_step.jpg')
    plt.savefig('./image/ratio_low_new/5GDDoS_Game_social_ratio_low_new_step.pdf')
    plt.savefig('./image/ratio_low_new/5GDDoS_Game_social_ratio_low_new_step.eps')
    data_dic = dict()
    ...
    fig_name = "ratio_low_new/5GDDoS_Game_social_ratio_low_new_step"
    fig = Fig(ratio, data_dic, x_title, y_title, fig_name, marker_dic)
    write_fig(fig, fig_name)
    plt.close()
    ...
    fig_name = "ratio_low_new/5GDDoS_Game_asp_ratio_low_new_step"
    fig = Fig(ratio, data_dic, x_title, y_title, fig_name, marker_dic)
    write_fig(fig, fig_name)
    plt.close()
    ...
    plt.xticks(fontsize=TICKS_FONT_SIZE)
    plt.yticks(fontsize=TICKS_FONT_SIZE)
    plt.savefig('./image/ratio_low_new/5GDDoS_Game_total_vm_ratio_low_new_step.jpg')
    plt.savefig('./image/ratio_low_new/5GDDoS_Game_total_vm_ratio_low_new_step.pdf')
    plt.savefig('./image/ratio_low_new/5GDDoS_Game_total_vm_ratio_low_new_step.eps')
    data_dic = dict()
    ...
    fig_name = "ratio_low_new/5GDDoS_Game_total_vm_ratio_low_new_step"
    fig = Fig(ratio, data_dic, x_title, y_title, fig_name, marker_dic)
    write_fig(fig, fig_name)
    plt.close()