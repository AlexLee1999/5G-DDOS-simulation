...
def plot_utility_high_low_ratio_cvx():
    ...
    plt.plot(num, utility_proposed_lst, marker='o', markerfacecolor='none', label='Proposed Scheme', linewidth=7, markersize=30)
    plt.plot(num, utility_zero_lst, marker='^', markerfacecolor='none', label='No IPS', linewidth=7, markersize=30)
    plt.plot(num, utility_five_lst, marker='s', markerfacecolor='none', label='5% IPS VM', linewidth=7, markersize=30)
    plt.plot(num, utility_seven_lst, marker='8', markerfacecolor='none', label='7% IPS VM', linewidth=7, markersize=30)
    plt.legend(loc="best", fontsize=100)
    plt.xlabel(r'$\bf{ASP\ RATIO}$', fontsize=100)
    ...
    plt.figure(figsize=(45, 25), dpi=400)
    plt.plot(num, social_proposed_lst, marker='o', markerfacecolor='none', label='Proposed Scheme', linewidth=7, markersize=30)
    plt.plot(num, social_zero_lst, marker='^', markerfacecolor='none', label='No IPS', linewidth=7, markersize=30)
    plt.plot(num, social_five_lst, marker='s', markerfacecolor='none', label='5% IPS VM', linewidth=7, markersize=30)
    plt.plot(num, social_seven_lst, marker='8', markerfacecolor='none', label='7% IPS VM', linewidth=7, markersize=30)
    plt.legend(loc="best", fontsize=100)
    plt.xlabel(r'$\bf{ASP\ RATIO}$', fontsize=100)
    ...
    plt.figure(figsize=(45, 25), dpi=400)
    plt.plot(num, asp_utility_proposed_lst, marker='o', markerfacecolor='none', label='Proposed Scheme', linewidth=7, markersize=30)
    plt.plot(num, asp_utility_zero_lst, marker='^', markerfacecolor='none', label='No IPS', linewidth=7, markersize=30)
    plt.plot(num, asp_utility_five_lst, marker='s', markerfacecolor='none', label='5% IPS VM', linewidth=7, markersize=30)
    plt.plot(num, asp_utility_seven_lst, marker='8', markerfacecolor='none', label='7% IPS VM', linewidth=7, markersize=30)
    plt.legend(loc="best", fontsize=100)
    plt.xlabel(r'$\bf{ASP\ RATIO}$', fontsize=100)
    ...
    plt.figure(figsize=(45, 25), dpi=400)
    plt.plot(num, vm_proposed_lst, marker='o', markerfacecolor='none', label='Proposed Scheme', linewidth=7, markersize=30)
    plt.plot(num, vm_zero_lst, marker='^', markerfacecolor='none', label='No IPS', linewidth=7, markersize=30)
    plt.plot(num, vm_five_lst, marker='s', markerfacecolor='none', label='5% IPS VM', linewidth=7, markersize=30)
    plt.plot(num, vm_seven_lst, marker='8', markerfacecolor='none', label='7% IPS VM', linewidth=7, markersize=30)
    plt.legend(loc="best", fontsize=100)
    plt.xlabel(r'$\bf{ASP\ RATIO}$', fontsize=100)
...
def plot_utility_high_low_ratio_step():
    ...
    for n in num:
        ...
        vm_seven_lst.append(vm_seven / ITER)
    plt.figure(figsize=(45, 25), dpi=400)
    plt.plot(x, utility_proposed_lst, marker='o', markerfacecolor='none', label='Proposed Scheme', linewidth=7, markersize=30)
    plt.plot(x, utility_zero_lst, marker='^', markerfacecolor='none', label='No IPS', linewidth=7, markersize=30)
    plt.plot(x, utility_five_lst, marker='s', markerfacecolor='none', label='5% IPS VM', linewidth=7, markersize=30)
    plt.plot(x, utility_seven_lst, marker='8', markerfacecolor='none', label='7% IPS VM', linewidth=7, markersize=30)
    plt.legend(loc="best", fontsize=100)
    plt.xlabel(r'$\bf{ASP\ RATIO}$', fontsize=100)
    plt.ylabel(r'$\bf{MPO\ Utility}$', fontsize=100)
    plt.xticks(x, values, fontsize=80)
    plt.yticks(fontsize=80)
    ...
    plt.figure(figsize=(45, 25), dpi=400)
    plt.plot(x, social_proposed_lst, marker='o', markerfacecolor='none', label='Proposed Scheme', linewidth=7, markersize=30)
    plt.plot(x, social_zero_lst, marker='^', markerfacecolor='none', label='No IPS', linewidth=7, markersize=30)
    plt.plot(x, social_five_lst, marker='s', markerfacecolor='none', label='5% IPS VM', linewidth=7, markersize=30)
    plt.plot(x, social_seven_lst, marker='8', markerfacecolor='none', label='7% IPS VM', linewidth=7, markersize=30)
    plt.legend(loc="best", fontsize=100)
    plt.xlabel(r'$\bf{ASP\ RATIO}$', fontsize=100)
    plt.ylabel(r'$\bf{Social\ Welfare}$', fontsize=100)
    plt.xticks(x, values, fontsize=80)
    ...
    plt.figure(figsize=(45, 25), dpi=400)
    plt.plot(x, asp_utility_proposed_lst, marker='o', markerfacecolor='none', label='Proposed Scheme', linewidth=7, markersize=30)
    plt.plot(x, asp_utility_zero_lst, marker='^', markerfacecolor='none', label='No IPS', linewidth=7, markersize=30)
    plt.plot(x, asp_utility_five_lst, marker='s', markerfacecolor='none', label='5% IPS VM', linewidth=7, markersize=30)
    plt.plot(x, asp_utility_seven_lst, marker='8', markerfacecolor='none', label='7% IPS VM', linewidth=7, markersize=30)
    plt.legend(loc="best", fontsize=100)
    plt.xlabel(r'$\bf{ASP\ RATIO}$', fontsize=100)
    plt.ylabel(r'$\bf{ASP\ Utility}$', fontsize=100)
    plt.xticks(x, values, fontsize=80)
    ...
    plt.figure(figsize=(45, 25), dpi=400)
    plt.plot(x, vm_proposed_lst, marker='o', markerfacecolor='none', label='Proposed Scheme', linewidth=7, markersize=30)
    plt.plot(x, vm_zero_lst, marker='^', markerfacecolor='none', label='No IPS', linewidth=7, markersize=30)
    plt.plot(x, vm_five_lst, marker='s', markerfacecolor='none', label='5% IPS VM', linewidth=7, markersize=30)
    plt.plot(x, vm_seven_lst, marker='8', markerfacecolor='none', label='7% IPS VM', linewidth=7, markersize=30)
    plt.legend(loc="best", fontsize=100)
    plt.xlabel(r'$\bf{ASP\ RATIO}$', fontsize=100)
    plt.ylabel(r'$\bf{Purchased\ VM}$', fontsize=100)
    plt.xticks(x, values, fontsize=80)
