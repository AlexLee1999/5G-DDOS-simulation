...
# task size
DEVICE_TASK_SIZE_UPPER = 1.5
DEVICE_TASK_SIZE_LOWER = 0.8

DEVICE_TASK_SIZE_HIGH_UPPER = 1.5
DEVICE_TASK_SIZE_HIGH_LOWER = 1.4

DEVICE_TASK_SIZE_LOW_UPPER = 0.9
DEVICE_TASK_SIZE_LOW_LOWER = 0.8
CPU_CYCLE_PER_BITS = 800
# arrival rate
DEVICE_ARRIVAL_RATE_UPPER = 0.3
DEVICE_ARRIVAL_RATE_LOWER = 0.1
# price per task
